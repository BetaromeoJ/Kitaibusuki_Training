// ============================================================
// 北指宿中学校 ICT研修ポータル 共通スクリプト
//
// 構成:
//   1. initSplash()        … オープニング演出。黒い幕が下から上へ流れて
//                              2秒程度で消える。sessionStorageを使い、
//                              同一セッション中は一度だけ表示する。
...
//   7. initTapLift()       … ボタンをタップしたときの小さな浮き上がり演出。
// ============================================================
...
function initSplash() {
  ...
  const storageKey = 'kh-splash-shown:' + location.pathname;
